...
class CreateBalanceComisionGerentesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('balance_comision_gerentes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('balance_comision_gerentes');
    }
}
