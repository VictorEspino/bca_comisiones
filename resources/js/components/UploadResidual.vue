            ...
            <div class="flex flex-1 flex-col">
                ...
                <div class="bg-white border-solid border-gray-300 rounded-lg border shadow-sm w-full mb-3">
                    <div class="text-white py-3 px-2 rounded-t-lg bg-gradient-to-br from-pink-600 to-yellow-300 boder-solid border-gray-300 border-b text-white font-bold">
                        ...
                        Carga de Archivo de Residuales
                    </div>
                    <div class="p-3">
                        <form @submit="cargarResidual" enctype="multipart/form-data">
                        <div class="flex flex-wrap  mb-6">
                            <div class="w-full px-3 mt-3">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                    Archivo de residual
                                </label>
                                <input v-on:change="onFileChangeResidual" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="cuotas"  type="file">
                            </div>
                        </div>
