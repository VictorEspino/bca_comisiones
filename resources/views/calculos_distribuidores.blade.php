<x-app-layout>
    ...
    <div class="text-xl text-gray-700 flex flex-col">
        ...
        <table>
                ...
                ?>
                    <tr class="">
                        <td class="border border-gray-300 font-light {{$color?'bg-gray-100':''}} text-gray-700 p-1 text-sm"><center><a href="/estado_cuenta_distribuidor/{{$registro->id}}"><i class="far fa-edit"></i></a></td>
                        ...
                        <td class="border border-gray-300 font-light {{$color?'bg-gray-100':''}} text-gray-700 p-1 text-sm">{{$registro->a_pagar}}</td>
                    </tr>
                <?php
                    $color=!$color;
                    }
